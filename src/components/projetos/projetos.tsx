    ...
    <section ref={sectionRef} className="py-10 md:py-24 bg-off-white font-texto overflow-hidden" id="portfolio">
      <div className="max-w-7xl mx-auto px-4 lg:px-8">
        ...
        >
                  ...
                  >
                    ...
                    <div className="w-full lg:w-1/2 p-5 sm:p-6 md:p-8 lg:p-16 flex flex-col h-full justify-between">
                      <div>
                        ...
                        <h3 className="text-2xl sm:text-3xl lg:text-5xl font-bold text-gray-900 mb-2 md:mb-4 lg:mb-6">
                          {projeto.titulo}
                        </h3>

                        <p className="text-gray-600 text-sm sm:text-base lg:text-xl leading-relaxed line-clamp-3 lg:line-clamp-none">
                          {projeto.descricao}
                        </p>
                      </div>
          ...
          {/* --- BOTÕES DE NAVEGAÇÃO TABLET / MOBILE (Embaixo) --- */}
