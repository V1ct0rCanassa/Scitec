...
function AreasAtuacao() {
  ...
  const areas = [
    {
      ...
      icone: Cpu,
      descricao: 'Sistemas e produtos digitais sob medida — do back-end ao front, unindo boas práticas de engenharia de software pra resolver o problema real do seu negócio.',
      link: '/tecnologia',
    ...
    },
    {
      ...
      icone: Database,
      descricao: 'Análise e inteligência artificial aplicada ao negócio: transformamos dados brutos em decisões, com modelos pensados pro seu contexto e sua operação.',
      link: '/dados',
    ...
    },
    {
      ...
      icone: Lightbulb,
      descricao: 'Soluções técnicas sob medida pra desafios específicos, unindo rigor de engenharia e criatividade pra resolver problemas que fogem do padrão.',
      link: '/engenharia',
      iconColor: 'text-verde',
      bgColor: 'bg-verde',
      // Inverte para roxo
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-off-white font-texto" id="setores">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {areas.map((area, index) => (
            <a
              ...
              style={{ transitionDelay: visible ? `${200 + index * 150}ms` : '0ms' }}
            >
              <div
                aria-hidden="true"
              ...
              <div className="relative flex flex-col flex-1 p-0.5">
                {/* Bordas dos cantos agora usam a cor dinâmica */}
                ...
                {/* Hover do card usa a cor dinâmica no border */}
                <div
                ...
                >
                  <div className="mb-4">
                    <area.icone size={36} className={`${area.iconColor} transition-transform duration-300 group-hover:scale-110 group-hover:-rotate-6`} />
                  </div>
                  ...
                  <div className="mt-4">
                    <span className={`${area.bgColor} text-white px-4 py-2 rounded-md text-sm font-semibold transition-transform duration-300 inline-block group-hover:scale-105`}>
                      Veja mais
                    </span>
                  </div>
                </div>
